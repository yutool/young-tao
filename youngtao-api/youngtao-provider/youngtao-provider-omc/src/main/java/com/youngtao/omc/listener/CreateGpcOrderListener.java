...
import com.youngtao.omc.flow.CreateGpcOrderFlowInvoke;
...
@RocketMQMessageListener(
        ...
        consumerGroup = "gpc-order-create-group-tmp",
        consumeMode = ConsumeMode.ORDERLY
)
public class CreateGpcOrderListener implements RocketMQListener<CreateOrderMessage> {
    @Autowired
    private CreateGpcOrderFlowInvoke invoke;
...
//
//        // 2 创建订单信息
//        GpcSkuDTO skuDTO = message.getSkuDTO();
