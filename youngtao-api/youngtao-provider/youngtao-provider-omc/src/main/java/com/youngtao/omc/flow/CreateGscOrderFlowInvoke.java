 ...
 */
@Component
public class CreateGscOrderFlowInvoke implements FlowInvoke<CreateOrderFlowData> {
    @Autowired
    private FreezeScoreHandler freezeScoreHandler;
    @Autowired
    private CreateGscOrderHandler createGscOrderHandler;
    @Autowired
    ...
    public void afterPropertiesSet() {
        ...
        handlerChain.add(createGscOrderHandler);
